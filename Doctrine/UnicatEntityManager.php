...
class UnicatEntityManager implements EntityManagerInterface
{
    /**
    ...
    public function __construct(Connection $conn, Configuration $config, EventManager $eventManager)
    {
        ...
        $this->unitOfWork        = new UnicatUnitOfWork($this);
    ...
    public function clear($entityName = null)
    {
        ...
        $this->unitOfWork->clear(null === $entityName ? null : $this->metadataFactory->getMetadataFor($entityName)
            ->getName()
        );
    }
     ...
     *
     * @return UnicatEntityManager The created EntityManager.
    ...
    public static function create($connection, Configuration $config, EventManager $eventManager = null)
    {
        ...
        return new UnicatEntityManager($connection, $config, $connection->getEventManager());
    }
